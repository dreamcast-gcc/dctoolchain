...
## Enter the dcdev directory.
cd "$(dirname "$0")" || { echo "ERROR: Could not enter the dcdev directory."; exit 1; }
...
## Check if repo is in a tag, to install this specfic Dreamcast Dev environment
